...
use App\Http\Controllers\Api\Artist\ArtistPodcastController;
use App\Http\Controllers\Api\Artist\ArtistPodcastEpisodeController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('artist')->middleware('artist')->group(function () {
        ...
        // Lyrics management
        Route::put('/songs/{songId}/lyrics', [LyricController::class, 'store']);
        ...
        // Podcast management
        Route::get('/podcasts', [ArtistPodcastController::class, 'index']);
        Route::post('/podcasts', [ArtistPodcastController::class, 'store']);
        Route::put('/podcasts/{id}', [ArtistPodcastController::class, 'update']);
        Route::delete('/podcasts/{id}', [ArtistPodcastController::class, 'destroy']);
        Route::get('/podcasts/{podcastId}/episodes', [ArtistPodcastEpisodeController::class, 'index']);
        Route::post('/podcasts/{podcastId}/episodes', [ArtistPodcastEpisodeController::class, 'store']);
        Route::put('/podcasts/{podcastId}/episodes/{episodeId}', [ArtistPodcastEpisodeController::class, 'update']);
        Route::delete('/podcasts/{podcastId}/episodes/{episodeId}', [ArtistPodcastEpisodeController::class, 'destroy']);

        // Artist profile by slug (must be LAST — catches any {slug})
    ...
    Route::prefix('admin')->middleware('admin')->group(function () {
        ...
        Route::patch('/songs/{id}/takedown', [AdminSongController::class, 'takedown']);
        Route::delete('/songs/{id}', [AdminSongController::class, 'destroy']);

        // Content Reports (admin-scoped)
        Route::get('/reports', [ContentReportController::class, 'index']);
        Route::patch('/reports/{id}', [ContentReportController::class, 'update']);
    });
});